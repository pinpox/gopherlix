...
func Test_createListing(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "Test root/subdir1/file4 dir reqest",
			reqPath: "testdata/subdir1/file4",
			want:    "file4content\r\n",
			wantErr: false,
		},
		{
			name:    "Test root/subdir1/file5 dir reqest",
			reqPath: "testdata/subdir1/file5",
			want:    "file5content\r\n",
			wantErr: false,
		},
		{
			name:    "Test root/subdir2/file2 dir reqest",
			reqPath: "testdata/subdir2/file2",
			want:    "file2content\r\n",
			wantErr: false,
		},
		{
			name:    "Test root/subdir2/file3 dir reqest",
